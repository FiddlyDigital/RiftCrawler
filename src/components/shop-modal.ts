...
export class ShopModal extends BaseModal {
  protected template(): string {
    return `<div class="modal-card" style="max-width:340px;">
      ...
      <p style="color:#666;margin:4px 0 4px 0;font-size:11px;">The red-capped peddler grins. "Gold for wonders, traveller. Fair trades, mostly."</p>
  ...
  /** Shows the shop modal for the given stock, with a live-updating gold balance as items are purchased. */
